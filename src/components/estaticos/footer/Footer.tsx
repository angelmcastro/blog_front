        ...
        <Grid alignItems="center" item xs={12}>
            ...
            <Box className='box1'>
                ...
                <Box display="flex" alignItems="center" justifyContent="center">
                    ...
                    <a href="https://www.facebook.com/angela.mendonca.7" target="_blank">
                        <FacebookIcon className='redes' />
                    </a>
                   
                    <a href="https://www.instagram.com/angelmcastro_/" target="_blank">
                        <InstagramIcon className='redes'/>
                    </a>
                   
                    <a href="https://www.linkedin.com/school/angelamendonca97/" target="_blank">
